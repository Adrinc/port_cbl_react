...
export default function Scene({ cameraRef, modelRef })
{
...
{/*    <OrbitControls/> */}
    ...
    <Suspense fallback={<Placeholder position-y={1} scale={[2, 3, 2]} />}>
        ...
        <BakeShadows />
        <VideoTextureCBLUNA/>
        <SpeedTestText rotation={[0, Math.PI/2,0]}   position={[-18.3, 1.03, -12.67]}/>
        <MenuText rotation={[0,0,0]}   position={[4, 1.5, -20.9]}/>
